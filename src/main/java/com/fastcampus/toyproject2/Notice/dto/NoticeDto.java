package com.fastcampus.toyproject2.Notice.dto;
...
public class NoticeDto {
    ...
    //Constructor
    public NoticeDto(){}
    //create용 생성자 - TODO) 생성후 바로 게시하지 않는 경우가 많다고 한다. is_post 매개변수를 추가할것.
    public NoticeDto(String notice_title, String notice_content, Integer writer, String is_top_post) {
