...
public class LoginDto {
    ...
    @Size(min = 8, max = 12, message = "ID must be between 8 and 12 characters")
    private String id;
    ...
    /* 회원 정보 조회 */
    public LoginDto(Integer member_number, String member_state_code, String id, String password,
